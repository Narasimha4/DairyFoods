...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        // Google maps API key
        GMSServices.provideAPIKey("AIzaSyDkdGbfToIXK8LPobV_tuQlosotKgGXG0k")
        GMSPlacesClient.provideAPIKey("AIzaSyDkdGbfToIXK8LPobV_tuQlosotKgGXG0k")
        
        
        let storyboard = UIStoryboard(name: "Main", bundle: nil)
        let rootViewController = storyboard.instantiateViewController(withIdentifier: isVerified ? "tabbar": "LoginVC" )
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "HariBol")
